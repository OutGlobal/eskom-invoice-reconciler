...
- **Level 1 (Public)**: Explains the *functional outcome* (e.g. "Every number is verified against authoritative meter readings and invoices").
- **Level 2 (Controlled)**: Explains *high-level architecture* (e.g. "Data flows through automated validation, unit normalization, and NERSA rate calculation").
