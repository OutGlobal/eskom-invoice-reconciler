...
describe("Deterministic Configurable Calendar & TOU Engine", () => {
  it("should classify High Season Weekday Peak, Standard, and Off-Peak hours correctly", () => {
    ...
    const resPeak = DeterministicCalendarEngine.classifyInterval(
    ...
    const resStd = DeterministicCalendarEngine.classifyInterval(
    ...
    const resOff = DeterministicCalendarEngine.classifyInterval(
  ...
  it("should classify Saturdays as Saturday schedule (Standard & Off-Peak only, no Peak)", () => {
    ...
    const resSatStd = DeterministicCalendarEngine.classifyInterval(
    ...
    const resSatOff = DeterministicCalendarEngine.classifyInterval(
  ...
  it("should classify Sundays as Off-Peak for all 24 hours", () => {
    ...
    const resSun = DeterministicCalendarEngine.classifyInterval(
  ...
  it("should classify gazetted public holidays as public_holiday with Off-Peak schedule", () => {
    ...
    const resYouth = DeterministicCalendarEngine.classifyInterval(
      "2025-06-16T06:00:00Z",
      new Decimal(100),
      ESKOM_MEGAFLEX_2025_2026,
    );
    ...
    const resHeritage = DeterministicCalendarEngine.classifyInterval(
  ...
  it("should apply Sunday-to-Monday public holiday substitution rule", () => {
    ...
    const resObserved = DeterministicCalendarEngine.classifyInterval(
  ...
  it("should classify special holidays (e.g. Election Day May 29 2024) correctly", () => {
    const resSpecial = DeterministicCalendarEngine.classifyInterval(
  ...
  it("should handle season transition boundaries (May 31 -> June 1)", () => {
    ...
    const resLowBoundary = DeterministicCalendarEngine.classifyInterval(
      "2025-05-31T21:45:00Z",
      new Decimal(100),
      ESKOM_MEGAFLEX_2025_2026,
    );
    ...
    const resHighBoundary = DeterministicCalendarEngine.classifyInterval(
      "2025-05-31T22:15:00Z",
      new Decimal(100),
      ESKOM_MEGAFLEX_2025_2026,
    );
  ...
  it("should handle leap year dates (29 February 2024)", () => {
    ...
    const resLeap = DeterministicCalendarEngine.classifyInterval(
  ...
  it("should handle top-of-hour interval boundary subtraction deterministically", () => {
    ...
    const resBoundary = DeterministicCalendarEngine.classifyInterval(
