...
export async function runIngestionPipeline(
  ...
  await syncInvoiceToSupabase({
    ...
    peak_kwh: invoice.peakKWh ?? undefined,
    standard_kwh: invoice.standardKWh ?? undefined,
    off_peak_kwh: invoice.offPeakKWh ?? undefined,
    total_kwh: invoice.totalKWh ?? undefined,
    max_demand_kva: invoice.maxDemandKVA ?? undefined,
    invoiced_total: invoice.invoiceTotal ?? undefined,
    status: "Processed",
    raw_json: invoice,
  });
