    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-start">
                ...
                <button
                  ...
                  className={`w-full text-left p-4 rounded-xl transition-all border block focus-ring-enera ${
                    isSelected
                      ...
                      : "bg-[#080d1a] border-white/5 hover:border-white/15"
                  }`}
                >
                  <div className="flex items-center justify-between text-[10px] font-mono mb-1.5">
                    <span
                      className={`${
                        isSelected ? "text-cyan-300 font-semibold" : "text-slate-500"
                      }`}
                    >
                      {q.category}
                    </span>
          ...
          <div className="lg:col-span-7 rounded-2xl bg-[#080d1a] border border-white/10 p-6 sm:p-8 space-y-6">
            ...
            <div>
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-white font-sans leading-tight">
                {current.outcomeTitle}
              </h3>
            </div>

            <div className="p-4 rounded-xl bg-[#050811] border border-white/5 text-sm text-slate-300 leading-relaxed font-sans">
              {current.outcomeDescription}
            </div>

            <div className="p-4 rounded-xl bg-[#091122] border border-cyan-500/20 flex items-start gap-3">
              <CheckCircle2 className="h-4 w-4 text-cyan-400 shrink-0 mt-0.5" />
              <div>
                <span className="text-xs font-semibold text-cyan-300 block mb-0.5 font-mono">
                  MANAGEMENT VALUE
                </span>
