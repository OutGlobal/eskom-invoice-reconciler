...
const FLOW_STAGES: FlowStage[] = [
  {
    ...
    shortDesc: "Physical interval meter data gathered directly from your facility.",
  ...
  },
  {
    ...
    shortDesc: "Utility invoice determinants and tariff charges for the billing period.",
  ...
  },
  {
    ...
    shortDesc: "Every line item calculated against official tariff rate schedules.",
  ...
  },
  {
    ...
    shortDesc: "Differences, overcharges, and calculation errors surfaced clearly.",
  ...
  },
  {
    ...
    shortDesc: "Evidence dossiers and verified reports to support financial decisions.",
