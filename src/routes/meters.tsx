...
export const Route = createFileRoute("/meters")({
  head: () => ({
    meta: [{ title: "Meter Master-Data & Configuration Subsystem — Eskom Reconciler" }],
  }),
...
export function MetersPage() {
  ...
  const handleSaveNewConfig = async () => {
    ...
    if (res.success && res.config) {
      toast.success(
        `Configuration Version #${res.config.version_number} saved & activated cleanly!`,
      );
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 p-6 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-sm">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
            5-Level Master Hierarchy, Versioned CT/VT Ratios, 3-Tier Values & Historical
            Reproducibility
          </p>
        </div>
        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="p-4 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-xs">
              ...
              <div className="mt-2 flex items-baseline justify-between">
                <span className="text-2xl font-bold text-gray-900 dark:text-gray-100">
                  {hierarchy?.sites.reduce(
                    (acc, s) => acc + s.pods.reduce((pAcc, p) => pAcc + p.meters.length, 0),
                    0,
                  ) || 0}{" "}
                  AMR
                </span>
              ...
              <span className="text-2xs text-gray-400 mt-1 block">
                {activeMeterData?.meter.manufacturer || "Meter"}{" "}
                {activeMeterData?.meter.model || ""}{" "}
                {activeMeterData?.meter.serial_number
                  ? `(#${activeMeterData.meter.serial_number})`
                  : ""}
              </span>
            </div>
            ...
            <div className="p-4 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-xs">
              ...
              <span className="text-2xs text-gray-400 mt-1 block">
                {activeMeterData?.pod.voltage_level_kv
                  ? `${activeMeterData.pod.voltage_level_kv} kV`
                  : "—"}{" "}
                ·{" "}
                {activeMeterData?.pod.notified_maximum_demand_kva
                  ? `${activeMeterData.pod.notified_maximum_demand_kva} kVA NMD`
                  : "—"}
              </span>
            </div>
            ...
            <div className="p-4 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-xs">
              ...
              <div className="mt-2 flex items-baseline justify-between">
                <span className="text-2xl font-bold text-emerald-600 dark:text-emerald-400">
                  {activeMeterData?.activeConfig?.overall_multiplier
                    ? `${activeMeterData.activeConfig.overall_multiplier}×`
                    : "—"}
                </span>
              ...
              <span className="text-2xs text-gray-400 mt-1 block">
                CT {activeMeterData?.activeConfig?.ct_ratio_numerator || "—"}/
                {activeMeterData?.activeConfig?.ct_ratio_denominator || "—"} × VT{" "}
                {activeMeterData?.activeConfig?.vt_ratio_numerator || "—"}/
                {activeMeterData?.activeConfig?.vt_ratio_denominator || "—"}
              </span>
            </div>
            ...
            <div className="p-4 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-xs">
              ...
              <div className="mt-2 flex items-baseline justify-between">
                <span className="text-2xl font-bold text-purple-600 dark:text-purple-400">
                  {configs.length} Versions
                </span>
                <History className="w-5 h-5 text-purple-500" />
              </div>
              <span className="text-2xs text-gray-400 mt-1 block">
                Historical Reproducibility Active
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-2.5 text-xs">
                  <div className="flex justify-between py-1 border-b border-gray-100 dark:border-gray-800">
                    ...
                    <span className="font-bold text-gray-900 dark:text-gray-100">
                      {activeMeterData?.meter.meter_number}
                    </span>
                  </div>
                  <div className="flex justify-between py-1 border-b border-gray-100 dark:border-gray-800">
                  ...
                  <div className="flex justify-between py-1 border-b border-gray-100 dark:border-gray-800">
                    ...
                    <span className="font-semibold text-blue-600 dark:text-blue-400">
                      {activeMeterData?.meter.meter_type}
                    </span>
                  </div>
                  <div className="flex justify-between py-1 border-b border-gray-100 dark:border-gray-800">
                    <span className="text-gray-500">Communication Source:</span>
                    <span className="text-gray-800 dark:text-gray-200">
                      {activeMeterData?.meter.communication_source}
                    </span>
                  </div>
                  <div className="flex justify-between py-1 border-b border-gray-100 dark:border-gray-800">
                    <span className="text-gray-500">Installation Date:</span>
                    <span className="text-gray-800 dark:text-gray-200">
                      {activeMeterData?.meter.installation_date}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg border border-gray-200 dark:border-gray-800 p-6 space-y-4">
                <div className="flex items-center justify-between border-b pb-3 dark:border-gray-800">
                  <h3 className="font-bold text-gray-900 dark:text-gray-100 text-base flex items-center gap-2">
                    <Calculator className="w-5 h-5 text-indigo-600" /> 3-Tier Meter Value Resolution
                    Engine
                  </h3>
                </div>
                ...
                <div className="space-y-3 text-xs">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setCalcInput((prev) => ({
                          ...prev,
                          rawPulses: parseFloat(e.target.value) || 0,
                        }))
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setCalcInput((prev) => ({ ...prev, selectedDate: e.target.value }))
                      }
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="p-2 bg-white dark:bg-gray-900 rounded-lg border border-indigo-100 dark:border-indigo-950">
                          ...
                          <span className="text-2xs text-gray-400 block mt-0.5">
                            Calculation: {derivedTieredReading.raw_register_value} ×{" "}
                            {derivedTieredReading.multiplier_applied}
                          </span>
                        </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg border border-gray-200 dark:border-gray-800 p-6 space-y-4">
                <div className="flex items-center justify-between border-b pb-3 dark:border-gray-800">
                  <div>
                    <h3 className="font-bold text-gray-900 dark:text-gray-100 text-base flex items-center gap-2">
                      <History className="w-5 h-5 text-purple-600" /> Versioned Configuration
                      History Timeline
                    </h3>
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                      Immutable effective date ranges ensure historical reconciliations are never
                      overwritten.
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  {configs.length === 0 ? (
                    <p className="text-sm text-gray-500 italic py-4">
                      No configuration history records loaded.
                    </p>
                  ) : (
                    configs
                          ...
                          >
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-gray-200 dark:border-gray-800 pb-3">
                              ...
                              <div className="flex items-center gap-1.5 text-xs text-gray-600 dark:text-gray-400 font-mono">
                                ...
                                <span>
                                  {cfg.effective_start_date} to{" "}
                                  {cfg.effective_end_date || "Active Present"}
                                </span>
                              </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-4 text-xs">
                              <div className="p-2.5 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800">
                                <span className="text-2xs text-gray-500 block font-semibold">
                                  CT Ratio
                                </span>
                                <span className="font-bold text-gray-900 dark:text-gray-100 font-mono">
                                  {cfg.ct_ratio_numerator} / {cfg.ct_ratio_denominator} (
                                  {cfg.ct_ratio}×)
                                </span>
                              </div>
                              ...
                              <div className="p-2.5 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800">
                                ...
                                <span className="font-bold text-gray-900 dark:text-gray-100 font-mono">
                                  {cfg.vt_ratio_numerator} / {cfg.vt_ratio_denominator} (
                                  {cfg.vt_ratio}×)
                                </span>
                              </div>
                            ...
                            <div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-800 flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-2xs text-gray-500">
                              ...
                              <span>
                                Reason: <strong>{cfg.change_reason || "Initial setup"}</strong> (By{" "}
                                {cfg.configured_by})
                              </span>
                            </div>
                          </div>
            ...
            <div className="space-y-3 text-xs">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewConfigForm((prev) => ({ ...prev, effective_end_date: e.target.value }))
                    }
                    className="w-full px-3 py-2 bg-white dark:bg-gray-950 border rounded-lg text-gray-900 dark:text-gray-100"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewConfigForm((prev) => ({
                        ...prev,
                        ct_ratio_numerator: parseFloat(e.target.value) || 0,
                      }))
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewConfigForm((prev) => ({
                        ...prev,
                        ct_ratio_denominator: parseFloat(e.target.value) || 0,
                      }))
                    }
                    className="w-full px-3 py-2 bg-white dark:bg-gray-900 border rounded-lg font-mono font-bold"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewConfigForm((prev) => ({
                        ...prev,
                        vt_ratio_numerator: parseFloat(e.target.value) || 0,
                      }))
                    }
                    className="w-full px-3 py-2 bg-white dark:bg-gray-900 border rounded-lg font-mono font-bold"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewConfigForm((prev) => ({
                        ...prev,
                        vt_ratio_denominator: parseFloat(e.target.value) || 0,
                      }))
                    }
                    className="w-full px-3 py-2 bg-white dark:bg-gray-900 border rounded-lg font-mono font-bold"
                  />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewConfigForm((prev) => ({ ...prev, multiplier_source: e.target.value }))
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewConfigForm((prev) => ({ ...prev, change_reason: e.target.value }))
                  }
                  className="w-full px-3 py-2 bg-white dark:bg-gray-950 border rounded-lg"
