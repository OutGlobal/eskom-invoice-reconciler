    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          Active customer profile used across analytics and reports.
        </p>
      </div>
      ...
      <Panel title="Customer Profile" subtitle="Edit the metadata attached to the current dataset.">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl">
          ...
          />
          <Field
            label="Notified Maximum Demand (kVA)"
            type="number"
      ...
      <Panel
        title="Customer List"
        subtitle="Multi-customer support is scaffolded — extend by adding an array store."
      >
