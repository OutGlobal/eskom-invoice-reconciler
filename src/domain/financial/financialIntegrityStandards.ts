...
export const FINANCIAL_INTEGRITY_STANDARDS = {
  ...
  regulatoryReferences: {
    sarsVatAct: "South African Value-Added Tax Act No. 89 of 1991, Section 65 (Calculation of Tax and Rounding)",
    nersaElectricityPricingPolicy: "NERSA Electricity Pricing Policy (EPP) Determinant Billing Guidelines",
    eskomRetailTariffStandard: "Eskom Schedule of Standard Prices (Megaflex / Miniflex / Nightsave)",
  },
  precisionStandards: {
  ...
  roundingRules: {
    ...
    vatApplication: "VAT (15%) MUST be computed against Subtotal Excl. VAT and rounded to 2 decimal places.",
  ...
  toleranceBands: {
    tier0RoundingThresholdZar: 0.10, // <= R 0.10: Immaterial / rounding noise
    tier1AcceptableToleranceZar: 50.00, // <= R 50.00 and <= 0.5%: Within normal tolerance
    tier2WarningThresholdZar: 5000.00, // > R 50.00 to R 5,000.00: Warning flagged
    tier3MaterialThresholdZar: 50000.00, // > R 5,000.00 to R 50,000.00: Material discrepancy
    tier4CriticalThresholdZar: 50000.00, // > R 50,000.00 or > 10%: Critical anomaly
  },
