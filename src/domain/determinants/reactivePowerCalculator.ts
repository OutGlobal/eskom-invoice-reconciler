...
export class ReactivePowerCalculator {
  ...
  public static calculateReactivePenalty(
    ...
    const excessKvarh = diffKvarh.gt(0)
      ? diffKvarh.toDecimalPlaces(2, Decimal.ROUND_HALF_UP)
      : new Decimal(0);
    const penaltyAmount = excessKvarh
      .mul(config.rate_per_kvarh)
