...
export class AuditTrailService {
    static inMemoryTrail = [];
    /**
     * Default system actor fallback
     */
    static DEFAULT_ACTOR = {
     ...
     */
    static calculateFieldDiffs(previousState, newState) {
        const diffs = [];
     ...
     */
    static async queryAuditTrail(filter = {}, pagination = {}) {
     ...
     */
    static async getRecordHistory(entityType, recordId, organisationId) {
     ...
     */
    static async exportAuditTrail(filter = {}, format = "json") {
