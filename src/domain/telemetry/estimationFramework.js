...
export class EstimationFrameworkEngine {
    static ENGINE_VERSION = "telemetry-estimation-v1.0";
    /**
     * Execute explicit estimation methodology for a missing telemetry gap
     */
    static estimateGap(params) {
        ...
        if (method === "LINEAR_INTERPOLATION") {
            ...
            const priorMatch = surroundingIntervals.find((i) => Math.abs(new Date(i.timestamp_utc).getTime() - targetPrior7DaysMs) < 1800 * 1000);
            if (priorMatch) {
